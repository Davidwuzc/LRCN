...
class LRCN_Hybrid:
    def __init__(self, data, target, n_outputs=5, length=4096, gpu=-1):
        ...
        self.model_name = 'LSTM_Model_hybrid3_copied'
        self.dump_name = 'LSTM_Model_hybrid3_copied'
    ...
    def train_and_test(self, n_epoch=200, batch=10):
        epoch = 1
        win = 0
        for seq in range(n_epoch):
            ...
            if epoch%1 ==0:
                ...
                print 'Total winning ratio: ', win,'/',epoch/1
                print '=================================='
...
class LRCN_Hybrid_Single:
    def __init__(self, data, target, n_outputs=5, length=4096, gpu=-1):

        self.model = Alex_Single(length, n_outputs)
        self.model_name = 'LSTM_Model_hybrid2_single_copied'
        self.dump_name = 'LSTM_Model_hybrid2_single_copied_'
